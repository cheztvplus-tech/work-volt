  ...
  function openPayslip(r) {
    ...
    var html =
      ...
      '<div class="bg-gradient-to-br from-slate-900 to-emerald-950 px-6 pt-6 pb-8 text-white relative overflow-hidden">'+
        ...
        '<button id="ps-close" class="flex-shrink-0 w-8 h-8 rounded-xl hover:bg-white/30 flex items-center justify-center text-white hover:text-white transition-colors border-none bg-white/20 cursor-pointer" style="position:absolute;top:1rem;right:1rem">✕</button>'+
