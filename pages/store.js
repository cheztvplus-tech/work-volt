...
window.WorkVoltPages['store'] = function(container) {
  ...
  const CATALOGUE = [
    ...
    { id:'garage',        label:'GarageOS',             icon:'fa-warehouse',          category:'Operations',   version:'1.0.0', description:'Manage repair orders, clients and pricing — fully private to your team. Contribute anonymized service history to a shared VIN intelligence network across all garages.', tags:['garage','repairs','vin','automotive'], color:'#0ea5e9', gradient:'from-sky-500 to-blue-600', featured:false }
  ];
