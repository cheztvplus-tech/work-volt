...
window.WorkVoltPages['store'] = function(container) {
  ...
  const CATALOGUE = [
    ...
    { id:'garage',        label:'GarageOS',             icon:'fa-garage-open',        category:'Operations',   version:'1.0.0', description:'Manage repair orders private to your garage, clients, and pricing — fully private to your team. Contribute anonymized service history to a shared VIN intelligence network across all garages.'  }
  ];
