...
window.WorkVoltPages['store'] = function(container) {
  ...
  const CATALOGUE = [
    ...
    { id:'pipeline',      label:'Pipeline',             icon:'fa-users',              category:'Sales',        version:'1.0.0', description:'Manage your sales pipeline with Kanban. Track deals from lead to close.', tags:['sales','pipeline'], color:'#3b82f6', gradient:'from-blue-500 to-indigo-600', featured:true },
    ...
    { id:'crm',           label:'CRM',                  icon:'fa-address-book',       category:'Sales',        version:'1.0.0', description:'Manage clients, contacts and interactions. Keep your relationship history searchable.', tags:['crm','clients'], color:'#ec4899', gradient:'from-pink-500 to-rose-500', featured:false },
    ...
    { id:'invoices',      label:'Invoice Manager',      icon:'fa-file-invoice-dollar',category:'Finance',      version:'1.0.0', description:'Create, send and track invoices. Manage payment status and overdue reminders.', tags:['finance','billing'], color:'#10b981', gradient:'from-emerald-500 to-teal-600', featured:true },
